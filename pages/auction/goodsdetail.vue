<template>
	<view class="goods-detail">
		...
		<view class="auction-goods-time flex-between ac">
			...
			<view class="dflex fdc ai-fe" v-if="auction.auctionStatus === 1">
				<view class="fs-24 lh-34 fc-f op75 mb10">距结束还剩</view>
				<view class="dflex ac fc-f">
					<view class="auction-time ml6 mr6">{{countDownArr[0]}}</view>:
					<view class="auction-time ml6 mr6">{{countDownArr[1]}}</view>:
					<view class="auction-time ml6 mr6">{{countDownArr[2]}}</view>
				</view>
			</view>
		</view>
