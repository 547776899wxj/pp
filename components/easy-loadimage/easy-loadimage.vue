<template>
    <view class="easy-loadimage" :id="uid">
        ...
        <view class="loadfail-img" v-show="isLoadError||!showImg"></view>
...
<style scoped>
    ...
    .loadfail-img{
         height: 100%;
         background: url('https://pp.hoshiibuy.com/static/easy-loadimage/loadfail.png') no-repeat center;
         background-size: 50%;
    }
    .loading-img{
        height: 100%;
    ...
    /* 转圈 */
    .spin-circle{
        background: url('https://pp.hoshiibuy.com/static/easy-loadimage/loading.gif') no-repeat center;
    ...
    @keyframes looming-gray{
        ...
        50%  {background-color:rgba(227,227,227,0.3);}
